...
--12
SELECT customer_name , product_name , quantity , unit_price , discount_percent , customer_type from sales_transactions
...
--19
SELECT transaction_id, customer_name, product_name, category, quantity, unit_price, discount_percent,payment_mode, city, salesperson
FROM sales_transactions
